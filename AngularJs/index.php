  ...
  /**
   * html file 
   * UI of login and registration using AngularJs
   */
  session_start();
  ...
  <body>
    <br />
    <h3 align="center">AngularJS Register Login Script</h3>
    <br />
...
<script>
    ...
    /**
     * .js file
     *  angularjs file included inside php file inside script tag
     */
